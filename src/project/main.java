...
public class main { //main class
    public static void main(String[] args) { // main method
        while (true){ // using while loop to keep running the application till the user exits
            ...
            System.out.println("Enter 1 for Binary format of a number");
            System.out.println("Enter 2 for Binary to Decimal");
            System.out.println("Enter 3 for Decimal to Binary");
            System.out.println("Enter 4 for Decimal to Hexadecimal");
            System.out.println("Enter 5 for Hexadecimal to Decimal") ;
            System.out.println("Enter 6 for Binary to Hexadecimal");
            System.out.println("Enter 7 for Hexadecimal to Binary");
            System.out.println("Enter 8 for Binary addition");
            ...
            try { // exception handling
                ...
                switch (input) { // using switch statement
                    case 1:
                        BinaryFormat binaryFormat = new BinaryFormat();// creating an object of the class
                        binaryFormat.binaryFormat();// using the object created to access the method in the class
                        break;
                    case 2:
